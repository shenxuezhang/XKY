		...
		cols.forEach((col, idx)=>{
			...
			div.innerHTML = `
				...
				<label class="inline-flex items-center cursor-pointer">
					<input type="checkbox" class="form-checkbox h-4 w-4 text-blue-600 rounded border-gray-300 transition focus:ring-blue-500" data-idx="${idx}" ${col.hidden ? 'checked' : ''}>
					<span class="ml-2 text-xs text-gray-500">隐藏</span>
				</label>
			`;
